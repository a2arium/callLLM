...
const sections = [
  ...
  },
  {
    ...
    pages: [
      ...
      ['docs/guides/reranking.md', 'Provider-neutral reranking, retrieval pipelines, document IDs, and provider options.'],

...
const mockExecuteWithRetry_1 = jest.fn();
const mockProcessStream = jest.fn();
const mockProcessStream_1 = jest.fn();
const mockStreamCall = jest.fn();
const mockExecuteWithRetry_2 = jest.fn();
const mockExecuteWithRetry_3 = jest.fn();
const mockExecuteWithRetry_4 = jest.fn();
const mockExecuteWithRetry_5 = jest.fn();
const mockExecuteWithRetry_6 = jest.fn();
const mockExecuteWithRetry_7 = jest.fn();
const mockExecuteWithRetry_8 = jest.fn();
const mockExecuteWithRetry_9 = jest.fn();
const mockExecuteWithRetry_10 = jest.fn();
const mockExecuteWithRetry_11 = jest.fn();
const mockExecuteWithRetry_12 = jest.fn();
const mockExecuteWithRetry_13 = jest.fn();
const mockExecuteWithRetry_14 = jest.fn();
const mockExecuteWithRetry_15 = jest.fn();
const mockExecuteWithRetry_16 = jest.fn();
const mockExecuteWithRetry_17 = jest.fn();
const mockExecuteWithRetry_18 = jest.fn();
const mockExecuteWithRetry_19 = jest.fn();
const mockExecuteWithRetry_20 = jest.fn();
const mockExecuteWithRetry_21 = jest.fn();
const mockExecuteWithRetry_22 = jest.fn();
const mockExecuteWithRetry_23 = jest.fn();
const mockExecuteWithRetry_24 = jest.fn();
const mockExecuteWithRetry_25 = jest.fn();
const mockExecuteWithRetry_1_1 = jest.fn();
const mockExecuteWithRetry_1_2 = jest.fn()
...
describe('StreamController', () => {
  ...
  it('should retry on acquireStream error and eventually succeed', async () => {
    ...
    mockExecuteWithRetry_1_1.mockImplementation(async <T,>(
      fn: () => Promise<T>,
  ...
  it('should use default maxRetries when not specified in settings', async () => {
    ...
    try {
      ...
      lastError = err as Error; errorCount++;
    }

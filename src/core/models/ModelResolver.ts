...
export function describeRequestRequirements(requirements: RequestRequirements): string[] {
    ...
    if (requirements.evaluation?.required) descriptions.push('evaluation');
    ...
    if (requirements.providerInterfaces?.evaluateCall) descriptions.push('provider evaluate interface');
